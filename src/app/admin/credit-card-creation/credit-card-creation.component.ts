...
@Component({
  selector: 'app-credit-card-creation',
  templateUrl: './credit-card-creation.component.html',
  styleUrl: './credit-card-creation.component.scss'
})
export class CreditCardCreationComponent {
  ...
  tabs = [
    { title: 'Customer Credit', component: CustomerCreditCardComponent },
    { title: 'Juristic Credit', component: JuristicCreditCardComponent }
  ];
