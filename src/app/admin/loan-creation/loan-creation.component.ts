...
export class LoanCreationComponent {
  ...
  totalCustomerCount: number = 0; // Overall count for customer requests
  totalJuristicCount: number = 0; // Overall count for juristic requests
  totalRequests: number = 0; 
  tabs = [
    { title: 'Customer Loan', component: CustomerLoanComponent },
    { title: 'Juristic Loan', component: JuristicLoanComponent }
  ];
  ...
  onSaveAndNext() {
    console.log('dsds', this.personalForm.errors);
  ...
  submitForm() {
    ...
    let data = {
      records: {
        ...
        loanType: this.loanDetails.value.loanType,
        loanTenure: this.loanDetails.value.loanTenure,
        loanAmount: this.loanDetails.value.loanAmount,
        purpose: this.loanDetails.value.purpose,
        collateral: this.loanDetails.value.collateral,
      },
    };
  ...
  getCustomerData() {
    this.adminService.get('/loanReqDet').subscribe((res) => {
  ...
  calculateTotalCounts() {
    ...
    this.totalCustomerCount = customerTotal;
    this.totalJuristicCount = juristicTotal;

    this.totalRequests = this.totalCustomerCount + this.totalJuristicCount;
  }
